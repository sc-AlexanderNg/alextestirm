...
const meta: Meta<typeof FeaturedCards> = {
  title: 'Components/FeaturedCards',
...
const card = {
  ...
  shortDescription: {
    jsonValue: {
      value:
        'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor...<ul><li>list item 1</li><li>list item 2<ul><li>list item 1</li><li>list item 2</li><li>list item 3</li></ul></li><li>list item 3</li></ul>',
    },
  },
  longDescription: {
    jsonValue: {
