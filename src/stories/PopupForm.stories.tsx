...
const meta: Meta<typeof PopupFormPage> = {
  title: 'Components/PopupForm',
  component: PopupFormPage,
  argTypes: {},
  parameters: {
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/rOV6xOuNIa5Jd0RR06Sz8N/Iron-Mountain-Component-Library?type=design&node-id=683-1238&t=ITAQpsrHUxw3ptrG-0',
    },
  },
};

export default meta;
type Story = StoryObj<typeof PopupFormPage>;
...
<form method="post" name="IMContactUsFormUK" action="https://s63835396.t.eloqua.com/e/f2" id="form100" class="elq-form" novalidate="novalidate">
    ...
    <select id="Area_of_Interest" name="C_Area_of_Interest1" data-rule-required="true" aria-required="true" data-msg-required="Please enter your Service of Interest">
    ...
    <textarea id="Comments" placeholder="Comments" name="Comments" data-hs-name="message" type="text" class="valid full-width" aria-invalid="false" maxlength="500"></textarea>
    </div>
    <div class="form-element">
    ...
    <input data-hs-name="utm_campaign_mr" name="gACampaignMostRecent1" id="field12" type="text" />
    <input data-hs-name="utm_medium_mr" name="gAMediumMostRecent1" id="field13" type="text" />
    <input data-hs-name="utm_source_mr" name="gASourceMostRecent1" id="field14" type="text" />
    <input data-hs-name="utm_term_mr" name="gASearchTermMostRecent1" id="field18" type="text" />
...
export const Default: Story = {
  args: {
    rendering: {
      componentName: 'PopupFormPage',
      dataSource: 'PopupFormPage',
    },
    fields: {
      FormHtml: {
        value: eloquaMarkup,
      ...
      SuccessMessage: {
        value: 'Thank you for submitting your information.',
      },
      ButtonText: {
        value: 'Go to full article',
      },
    },
  },
};
