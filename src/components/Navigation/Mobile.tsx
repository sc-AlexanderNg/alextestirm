...
const Mobile = (props: NavigationProps): JSX.Element => {
  ...
  if (
    process.env.NEXT_PUBLIC_EXPRESS_CART_HOSTNAME &&
    process.env.NEXT_PUBLIC_EXPRESS_CART_JS_URL &&
    process.env.NEXT_PUBLIC_EXPRESS_CART_CSS_URL
  ) {
    ECartHost = process.env.NEXT_PUBLIC_EXPRESS_CART_HOSTNAME;
    ECartJsURL = process.env.NEXT_PUBLIC_EXPRESS_CART_JS_URL;
    ECartCssURL = process.env.NEXT_PUBLIC_EXPRESS_CART_CSS_URL;
  }

  const isECartHost = Boolean(ECartHost);
  ...
  const ecartHTMLPage = (
    <div
      ...
      id="imcom-cart-icon-container-mobile"
    >
      ...
      <div id="dynamic-cart-icon-mobile"></div>
  ...
  const displayBaseNavigations = () => {
    ...
    return (
      <div id={styles['slide-right']} className={styles['links-container']}>
        <div className={styles.l1Links}>
          {isECartHost && ecartHTMLPage}
          {mainSection}
        </div>
        <UtilityNavigation
